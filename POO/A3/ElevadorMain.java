...
public class ElevadorMain {
    public static void main(String[] args) {
        ...
        //dei a liberdade do usario informar o total de andares e a capacidade,
        //nem todo elevador cabe o mesmo tanto e nem todo prédio tem o mesmo N° de andares
        ...
        System.out.println("2- Remover um Pessoa");
        System.out.println("3- Subir um andar");
        System.out.println("4- Descer um andar");
        System.out.println("5- Status do elevador");
        ...
        } while (escolha!=6); //final do DoWhile
        in.close();
    }
}
